...
export default function MusicShowcase() {
  const [bands, setBands] = useState<Band[]>([
    ...
    {
      name: "eileen",
      description: "My Band - Check out our music!",
  ...
  return (
    <div className="h-full p-5 bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-purple-900/20 dark:via-slate-800 dark:to-blue-900/20 rounded-2xl border border-purple-200 dark:border-purple-800 shadow-md">
      {/* Header */}
