            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {skills.map((skill, index) => (
                  ...
                  >
                    <div className="text-2xl mb-2 text-center lg:text-left">
                      {skill.icon === "git" ? (
                        <svg className="w-8 h-8 text-orange-600 dark:text-orange-400 mx-auto lg:mx-0" fill="currentColor" viewBox="0 0 24 24">
